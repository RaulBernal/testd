...
import (
	...
	testmodulev1 "github.com/BitCannaGlobal/test/api/test/test/module"
	_ "github.com/BitCannaGlobal/test/x/test/module" // import for side-effects
	testmoduletypes "github.com/BitCannaGlobal/test/x/test/types"
